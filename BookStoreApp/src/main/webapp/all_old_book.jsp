...
<div class="container-fluid">
		<div class="row p-3">
			<%
				...
				List<BookDetails> list1 = bdao.getAllOldBook();
				...
				<div class="card card-ho mt-2">
					<div class="card-body text-center">
						...
						<p>Categories:<%=bds.getBook_Category() %></p>
						<div class="row">
							...
							%>
							<a href="oldcart?bid=<%=bds.getBook_Id()%>&&uid=<%=u.getId()%>"
							...
							%>
							 ...
							 <a href="" class="btn btn-danger btn-sm ml-1"><i class="fa-solid fa-indian-rupee-sign"></i><%=bds.getBook_Price()%></a>
						</div>
					</div>
				</div>
               </div>
